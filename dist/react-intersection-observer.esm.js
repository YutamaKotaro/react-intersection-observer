  ...
  render() {
    ...
    const _this$props = this.props,
      ...
      tag
          ...
          props = _objectWithoutPropertiesLoose(_this$props, ["children", "as", "tag", "triggerOnce", "threshold", "root", "rootMargin", "onChange", "skip", "trackVisibility", "delay", "initialInView"]);
...
function useInView({
  ...
  const setRef = useCallback(node => {
    ...
    if (node) {
      unobserve.current = observe(targetNode, (inView, entry) => {
        setState({
          inView,
          entry
        });
